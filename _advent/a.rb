a = %w[rhqrpdxsqhgxzknr2foursnrcfthree
2bmckl
four95qvkvveight5
...
strings = ["797ninetwotwo", "dfjnzxtlnine9five"]

calibration_values = a.map do |str|
  first_digit = str[/\d/].to_i
  last_digit = str[/\d(?=\D*$)/].to_i
  first_digit * 10 + last_digit
  # or (first_digit.to_s + last_digit.to_s).to_i
end

p calibration_values.sum

mapk = %w[one two three four five six seven eight nine]
mapv = %w[1 2 3 4 5 6 7 8 9]
p spelled_out_to_digitx = mapk.zip(mapv).to_h

...
arr = Array.new(80000) { rand(1..450) }

number_of_pairs_v1_time = Benchmark.realtime do
  number_of_pairs_v1(arr)
end
puts "Quicksort took #{number_of_pairs_v1_time} seconds"

number_of_pairs_v2_time = Benchmark.realtime do
  number_of_pairs_v2(arr)
end
puts "Quicksort took #{number_of_pairs_v2_time} seconds"
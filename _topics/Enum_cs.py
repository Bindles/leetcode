...
print(result)
array = [1,2,3,4]
print([arr for arr in array if arr % 2 == 0])
...
result = [x * 100 for x in [1, 2, 3] if x > 1]
print(result)
...
# find_all(SELECT) - Returns an array containing all elements in the collection that satisfy the given condition
...
# reject (SELECT)[BC] - Returns a new array containing the items in the collection that do not satisfy the given condition
...
# select (FIND_ALL) - Returns a new array containing the items in the collection that satisfy the given condition
